...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    IDXGISwapChain1* d3d11SwapChain;
    {
        ...
        HRESULT hResult = dxgiFactory->CreateSwapChainForHwnd(d3d11Device, hwnd, 
    ...
    ID3D11VertexShader* vertexShader;
    {
        ...
        hResult = d3d11Device->CreateVertexShader(vsBlob->GetBufferPointer(), vsBlob->GetBufferSize(), 
    ...
    ID3D11InputLayout* inputLayout;
    {
        ...
        HRESULT hResult = d3d11Device->CreateInputLayout(inputElementDesc, 
            ARRAYSIZE(inputElementDesc), vsBlob->GetBufferPointer(), 
    ...
    UINT offset;
    {
        ...
        HRESULT hResult = d3d11Device->CreateBuffer(&vertexBufferDesc, 
